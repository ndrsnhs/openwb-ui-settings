<template>
  <div class="device-fronius-inverter-production-meter">
    ...
    >
      <template #help>
        Die Meter ID des SmartMeters an dem der Wechselrichter angeschlossen wurde. Diese ist normalerweise 1. Bei mehreren SmartMetern im System kann es notwendig
